...
export default function Hero(){
    ...
    return(
        <div className="lg:p-9 p-4 lg:flex-row  flex flex-col gap-24     ">
           ...
           <div className=" -mt-14 ">
            <img src="../assets/personalPicture.png" className="h-auto xl:max-w-lg max-w-xs mx-auto  shadow-purple-950 shadow-md outline-2 border-2 border-t-0 rounded-4xl  px-3   xl:-translate-x-2.5 border-purple-950  mix-blend-screen  " alt="personal_picture"/>
           </div>
        </div>
    )
}